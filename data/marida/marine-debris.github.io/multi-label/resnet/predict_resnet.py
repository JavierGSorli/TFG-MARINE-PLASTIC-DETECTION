...
_MARIDA_ROOT = Path(__file__).resolve().parents[2]
_MARIDA_RESNET = Path(__file__).resolve().parent
sys.path.insert(0, str(_MARIDA_ROOT / "utils"))
sys.path.insert(0, str(_MARIDA_RESNET))
